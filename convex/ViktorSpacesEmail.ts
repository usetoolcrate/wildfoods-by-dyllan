...
async function sendEmail({
  ...
  // Identifies this space across workspaces (project names are only unique
  // per owner); optional, the backend falls back to name + secret.
  const spaceId = process.env.VIKTOR_AUTH_RESOURCE_ID;
